...
export class ValuetypeService {
  ...
  constructor(@Inject('VALUETYPE_REPOSITORY') private valuetypeRepository: typeof Valuetype) {}
  ...
  async findAll(query:any): Promise<Valuetype[]> {
    const res = await paginateFilterUrl.query(this.valuetypeRepository, query, {});
